...
[Documentation](../../README.md) › [Filtrage](../README.md) › Stacking
...
- [Traitement des lights](../../LIGHT_PROCESSOR_GUIDE.md) : commandes et déroulement complet.
- [Séquences Siril](../../SIRIL_SEQUENCE.md) : représentation des images, mesures et transformations.
- [Mosaïques](../../MOSAIC_GUIDE.md) : assemblage de champs après leur traitement.
